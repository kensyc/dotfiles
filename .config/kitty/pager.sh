...
exec nvim 63<&0 0</dev/null \
    ...
    -c "set shell=bash scrollback=100000 termguicolors laststatus=0 clipboard+=unnamedplus number relativenumber" \
    -c "hi Normal guibg=#1e1e2e" \
    -c "hi LineNr guifg=#a6adc8" \
