...
local on_attach = function(_, bufnr)
    ...
    vim.keymap.set('n', '<leader>ls', require('telescope.builtin').lsp_document_symbols, buffopts)
    vim.keymap.set('n', '<leader>ld', require('telescope.builtin').diagnostics, buffopts)
    vim.keymap.set('n', '<leader>fo', '<cmd>lua vim.lsp.buf.formatting()<CR>', buffopts)
