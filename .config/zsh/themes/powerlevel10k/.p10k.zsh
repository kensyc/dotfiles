# Generated by Powerlevel10k configuration wizard on 2020-09-23 at 22:00 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_SHORTEN_FOLDER_MARKER="%B(${(j:|:)anchor_files})%b"
  ...
  #typeset -g POWERLEVEL9K_{ETC,FOLDER,HOME,HOME_SUB}_CONTENT_EXPANSION='%B${P9K_CONTENT}%b'
  typeset -g POWERLEVEL9K_DIR_CLASSES=(
    '*' DEFAULT ''
  )

  typeset -g POWERLEVEL9K_DIR_DEFAULT_CONTENT_IDENTIFIER_EXPANSION='%B${POWERLEVEL9K_CONTENT}%b'
  #####################################[ vcs: git status ]######################################
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      res+="%B${clean}${clean}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}%b"
